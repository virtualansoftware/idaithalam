...
public class ExcelToCollectionGeneratorTests {
    ...
    public void createCollectionTest_HappyPath() throws IOException, UnableToProcessException, URISyntaxException {
        ...
        JSONArray actualSheet_0 = new JSONArray(getFileAsString(new FileInputStream("target/1/CSS-Accept-DB-0.json")));
        ...
        JSONArray actualSheet_1 = new JSONArray(getFileAsString(new FileInputStream("target/1/CSS-Reject-DB-1.json")));
    ...
    public void createCollectionTest_With_Kafka() throws IOException, UnableToProcessException {
        ...
        JSONArray actualSheet_0 = new JSONArray(getFileAsString(new FileInputStream("target/2/API-Testing-0.json")));
    ...
    public void createCollectionTest_Multirun() throws IOException, UnableToProcessException {
        ...
        JSONArray actualSheet_0 = new JSONArray(getFileAsString(new FileInputStream("target/4/API-Testing-0.json")));
    ...
    public void createCollectionTest_Single_Workflow() throws IOException, UnableToProcessException {
        ...
        JSONArray actualSheet_0 = new JSONArray(getFileAsString(new FileInputStream("target/3/PetGet-0.json")));
        ...
        JSONArray actualSheet = new JSONArray(getFileAsString(new FileInputStream("target/3/PetGet-1.json")));
